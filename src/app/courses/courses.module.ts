...
import {
  MatDatepickerModule, MatDialogModule, MatInputModule, MatPaginatorModule, MatProgressSpinnerModule,
...
import {coursesReducer} from './state/course/course.reducers';
import {lessonsReducer} from './state/lesson/lessons.reducer';
import {LessonEffects} from './state/lesson/lesson.effects';
